...
void microkernel_all16(double*, double*, double*);
...
void microkernel_all16(const double* A, const double* B, double* C) {
#ifdef __AVX512F__
  __asm__ __volatile__("movq %0, %%rdi\n\t"
                       ...
                       "vmovapd 1152(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 64(%%rsi)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 64(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 64(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 64(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 64(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 64(%%r10)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 64(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 64(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 64(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       ...
                       "vfmadd231pd 72(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 72(%%r10)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 72(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 72(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 72(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "vmovapd 1408(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 80(%%rsi)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 80(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 80(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 80(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 80(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 80(%%r10)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 80(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 80(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 80(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       ...
                       "vfmadd231pd 88(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 88(%%r10)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 88(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 88(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 88(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "vmovapd 1664(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 96(%%rsi)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 96(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 96(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 96(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 96(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 96(%%r10)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 96(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 96(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 96(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       ...
                       "vfmadd231pd 104(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 104(%%r10)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 104(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 104(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 104(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "vmovapd 1920(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 112(%%rsi)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 112(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 112(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 112(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 112(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 112(%%r10)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 112(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 112(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 112(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       ...
                       "vfmadd231pd 120(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 120(%%r10)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 120(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 120(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 120(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "vmovapd %%zmm16, 0(%%rdx)\n\t"
...
void microkernel_MN16_K128(const double* A, const double* B, double* C) {
#ifdef __AVX512F__
  __asm__ __volatile__("movq %0, %%rdi\n\t"
                       "movq %1, %%rsi\n\t"
                       "movq %2, %%rdx\n\t"
                       ...
                       "addq $8, %%r12\n\t"
                       "vmovapd 0(%%rdx), %%zmm6\n\t"
                       "vmovapd 1024(%%rdx), %%zmm7\n\t"
                       "vmovapd 2048(%%rdx), %%zmm8\n\t"
                       "vmovapd 3072(%%rdx), %%zmm9\n\t"
                       "vmovapd 4096(%%rdx), %%zmm10\n\t"
                       "vmovapd 5120(%%rdx), %%zmm11\n\t"
                       "vmovapd 6144(%%rdx), %%zmm12\n\t"
                       "vmovapd 7168(%%rdx), %%zmm13\n\t"
                       "vmovapd 8192(%%rdx), %%zmm14\n\t"
                       "vmovapd 9216(%%rdx), %%zmm15\n\t"
                       "vmovapd 10240(%%rdx), %%zmm16\n\t"
                       "vmovapd 11264(%%rdx), %%zmm17\n\t"
                       "vmovapd 12288(%%rdx), %%zmm18\n\t"
                       "vmovapd 13312(%%rdx), %%zmm19\n\t"
                       "vmovapd 14336(%%rdx), %%zmm20\n\t"
                       "vmovapd 15360(%%rdx), %%zmm21\n\t"
                       "vmovapd 16384(%%rdx), %%zmm22\n\t"
                       "vmovapd 17408(%%rdx), %%zmm23\n\t"
                       "vmovapd 18432(%%rdx), %%zmm24\n\t"
                       "vmovapd 19456(%%rdx), %%zmm25\n\t"
                       "vmovapd 20480(%%rdx), %%zmm26\n\t"
                       "vmovapd 21504(%%rdx), %%zmm27\n\t"
                       "vmovapd 22528(%%rdx), %%zmm28\n\t"
                       "vmovapd 23552(%%rdx), %%zmm29\n\t"
                       "vmovapd 24576(%%rdx), %%zmm30\n\t"
                       "vmovapd 25600(%%rdx), %%zmm31\n\t"
                       "pushq %%rdx\n\t"
                       "movq $128, %%r15\n\t"
                       "movq $384, %%rax\n\t"
                       "movq $640, %%rbx\n\t"
                       ...
                       "vmovapd 1152(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 64(%%rsi)%{1to8%}, %%zmm0, %%zmm6\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm7\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm8\n\t"
                       "vfmadd231pd 64(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm9\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm10\n\t"
                       "vfmadd231pd 64(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm11\n\t"
                       "vfmadd231pd 64(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm12\n\t"
                       "vfmadd231pd 64(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm13\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm14\n\t"
                       "vfmadd231pd 64(%%r10)%{1to8%}, %%zmm0, %%zmm15\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 64(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 64(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 64(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 64(%%r10,%%r11,1)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,8)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 64(%%rdx)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 64(%%rdx,%%r15,1)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 64(%%rdx,%%r15,2)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 64(%%rdx,%%rax,1)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 64(%%rdx,%%r15,4)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 64(%%rdx,%%rbx,1)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 64(%%rdx,%%rax,2)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 64(%%rdx,%%r11,1)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       "vmovapd 1280(%%rdi), %%zmm0\n\t"
                       "vfmadd231pd 72(%%rsi)%{1to8%}, %%zmm1, %%zmm6\n\t"
                       "vfmadd231pd 72(%%rsi,%%r15,1)%{1to8%}, %%zmm1, %%zmm7\n\t"
                       "vfmadd231pd 72(%%rsi,%%r15,2)%{1to8%}, %%zmm1, %%zmm8\n\t"
                       "vfmadd231pd 72(%%rsi,%%rax,1)%{1to8%}, %%zmm1, %%zmm9\n\t"
                       "vfmadd231pd 72(%%rsi,%%r15,4)%{1to8%}, %%zmm1, %%zmm10\n\t"
                       "vfmadd231pd 72(%%rsi,%%rbx,1)%{1to8%}, %%zmm1, %%zmm11\n\t"
                       "vfmadd231pd 72(%%rsi,%%rax,2)%{1to8%}, %%zmm1, %%zmm12\n\t"
                       "vfmadd231pd 72(%%rsi,%%r11,1)%{1to8%}, %%zmm1, %%zmm13\n\t"
                       "vfmadd231pd 72(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm14\n\t"
                       "vfmadd231pd 72(%%r10)%{1to8%}, %%zmm1, %%zmm15\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm16\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm17\n\t"
                       "vfmadd231pd 72(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm18\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm19\n\t"
                       "vfmadd231pd 72(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm20\n\t"
                       "vfmadd231pd 72(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm21\n\t"
                       "vfmadd231pd 72(%%r10,%%r11,1)%{1to8%}, %%zmm1, %%zmm22\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,8)%{1to8%}, %%zmm1, %%zmm23\n\t"
                       "vfmadd231pd 72(%%rdx)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 72(%%rdx,%%r15,1)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 72(%%rdx,%%r15,2)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 72(%%rdx,%%rax,1)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 72(%%rdx,%%r15,4)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 72(%%rdx,%%rbx,1)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 72(%%rdx,%%rax,2)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 72(%%rdx,%%r11,1)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "vmovapd 1408(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 80(%%rsi)%{1to8%}, %%zmm0, %%zmm6\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm7\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm8\n\t"
                       "vfmadd231pd 80(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm9\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm10\n\t"
                       "vfmadd231pd 80(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm11\n\t"
                       "vfmadd231pd 80(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm12\n\t"
                       "vfmadd231pd 80(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm13\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm14\n\t"
                       "vfmadd231pd 80(%%r10)%{1to8%}, %%zmm0, %%zmm15\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 80(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 80(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 80(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 80(%%r10,%%r11,1)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,8)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 80(%%rdx)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 80(%%rdx,%%r15,1)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 80(%%rdx,%%r15,2)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 80(%%rdx,%%rax,1)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 80(%%rdx,%%r15,4)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 80(%%rdx,%%rbx,1)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 80(%%rdx,%%rax,2)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 80(%%rdx,%%r11,1)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       "vmovapd 1536(%%rdi), %%zmm0\n\t"
                       "vfmadd231pd 88(%%rsi)%{1to8%}, %%zmm1, %%zmm6\n\t"
                       "vfmadd231pd 88(%%rsi,%%r15,1)%{1to8%}, %%zmm1, %%zmm7\n\t"
                       "vfmadd231pd 88(%%rsi,%%r15,2)%{1to8%}, %%zmm1, %%zmm8\n\t"
                       "vfmadd231pd 88(%%rsi,%%rax,1)%{1to8%}, %%zmm1, %%zmm9\n\t"
                       "vfmadd231pd 88(%%rsi,%%r15,4)%{1to8%}, %%zmm1, %%zmm10\n\t"
                       "vfmadd231pd 88(%%rsi,%%rbx,1)%{1to8%}, %%zmm1, %%zmm11\n\t"
                       "vfmadd231pd 88(%%rsi,%%rax,2)%{1to8%}, %%zmm1, %%zmm12\n\t"
                       "vfmadd231pd 88(%%rsi,%%r11,1)%{1to8%}, %%zmm1, %%zmm13\n\t"
                       "vfmadd231pd 88(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm14\n\t"
                       "vfmadd231pd 88(%%r10)%{1to8%}, %%zmm1, %%zmm15\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm16\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm17\n\t"
                       "vfmadd231pd 88(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm18\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm19\n\t"
                       "vfmadd231pd 88(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm20\n\t"
                       "vfmadd231pd 88(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm21\n\t"
                       "vfmadd231pd 88(%%r10,%%r11,1)%{1to8%}, %%zmm1, %%zmm22\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,8)%{1to8%}, %%zmm1, %%zmm23\n\t"
                       "vfmadd231pd 88(%%rdx)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 88(%%rdx,%%r15,1)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 88(%%rdx,%%r15,2)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 88(%%rdx,%%rax,1)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 88(%%rdx,%%r15,4)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 88(%%rdx,%%rbx,1)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 88(%%rdx,%%rax,2)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 88(%%rdx,%%r11,1)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "vmovapd 1664(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 96(%%rsi)%{1to8%}, %%zmm0, %%zmm6\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm7\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm8\n\t"
                       "vfmadd231pd 96(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm9\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm10\n\t"
                       "vfmadd231pd 96(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm11\n\t"
                       "vfmadd231pd 96(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm12\n\t"
                       "vfmadd231pd 96(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm13\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm14\n\t"
                       "vfmadd231pd 96(%%r10)%{1to8%}, %%zmm0, %%zmm15\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 96(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 96(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 96(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 96(%%r10,%%r11,1)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,8)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 96(%%rdx)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 96(%%rdx,%%r15,1)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 96(%%rdx,%%r15,2)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 96(%%rdx,%%rax,1)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 96(%%rdx,%%r15,4)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 96(%%rdx,%%rbx,1)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 96(%%rdx,%%rax,2)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 96(%%rdx,%%r11,1)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       "vmovapd 1792(%%rdi), %%zmm0\n\t"
                       "vfmadd231pd 104(%%rsi)%{1to8%}, %%zmm1, %%zmm6\n\t"
                       "vfmadd231pd 104(%%rsi,%%r15,1)%{1to8%}, %%zmm1, %%zmm7\n\t"
                       "vfmadd231pd 104(%%rsi,%%r15,2)%{1to8%}, %%zmm1, %%zmm8\n\t"
                       "vfmadd231pd 104(%%rsi,%%rax,1)%{1to8%}, %%zmm1, %%zmm9\n\t"
                       "vfmadd231pd 104(%%rsi,%%r15,4)%{1to8%}, %%zmm1, %%zmm10\n\t"
                       "vfmadd231pd 104(%%rsi,%%rbx,1)%{1to8%}, %%zmm1, %%zmm11\n\t"
                       "vfmadd231pd 104(%%rsi,%%rax,2)%{1to8%}, %%zmm1, %%zmm12\n\t"
                       "vfmadd231pd 104(%%rsi,%%r11,1)%{1to8%}, %%zmm1, %%zmm13\n\t"
                       "vfmadd231pd 104(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm14\n\t"
                       "vfmadd231pd 104(%%r10)%{1to8%}, %%zmm1, %%zmm15\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm16\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm17\n\t"
                       "vfmadd231pd 104(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm18\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm19\n\t"
                       "vfmadd231pd 104(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm20\n\t"
                       "vfmadd231pd 104(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm21\n\t"
                       "vfmadd231pd 104(%%r10,%%r11,1)%{1to8%}, %%zmm1, %%zmm22\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,8)%{1to8%}, %%zmm1, %%zmm23\n\t"
                       "vfmadd231pd 104(%%rdx)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 104(%%rdx,%%r15,1)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 104(%%rdx,%%r15,2)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 104(%%rdx,%%rax,1)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 104(%%rdx,%%r15,4)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 104(%%rdx,%%rbx,1)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 104(%%rdx,%%rax,2)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 104(%%rdx,%%r11,1)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "vmovapd 1920(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 112(%%rsi)%{1to8%}, %%zmm0, %%zmm6\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm7\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm8\n\t"
                       "vfmadd231pd 112(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm9\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm10\n\t"
                       "vfmadd231pd 112(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm11\n\t"
                       "vfmadd231pd 112(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm12\n\t"
                       "vfmadd231pd 112(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm13\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm14\n\t"
                       "vfmadd231pd 112(%%r10)%{1to8%}, %%zmm0, %%zmm15\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 112(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 112(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 112(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 112(%%r10,%%r11,1)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,8)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 112(%%rdx)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 112(%%rdx,%%r15,1)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 112(%%rdx,%%r15,2)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 112(%%rdx,%%rax,1)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 112(%%rdx,%%r15,4)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 112(%%rdx,%%rbx,1)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 112(%%rdx,%%rax,2)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 112(%%rdx,%%r11,1)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       "vfmadd231pd 120(%%rsi)%{1to8%}, %%zmm1, %%zmm6\n\t"
                       "vfmadd231pd 120(%%rsi,%%r15,1)%{1to8%}, %%zmm1, %%zmm7\n\t"
                       "vfmadd231pd 120(%%rsi,%%r15,2)%{1to8%}, %%zmm1, %%zmm8\n\t"
                       "vfmadd231pd 120(%%rsi,%%rax,1)%{1to8%}, %%zmm1, %%zmm9\n\t"
                       "vfmadd231pd 120(%%rsi,%%r15,4)%{1to8%}, %%zmm1, %%zmm10\n\t"
                       "vfmadd231pd 120(%%rsi,%%rbx,1)%{1to8%}, %%zmm1, %%zmm11\n\t"
                       "vfmadd231pd 120(%%rsi,%%rax,2)%{1to8%}, %%zmm1, %%zmm12\n\t"
                       "vfmadd231pd 120(%%rsi,%%r11,1)%{1to8%}, %%zmm1, %%zmm13\n\t"
                       "vfmadd231pd 120(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm14\n\t"
                       "vfmadd231pd 120(%%r10)%{1to8%}, %%zmm1, %%zmm15\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm16\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm17\n\t"
                       "vfmadd231pd 120(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm18\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm19\n\t"
                       "vfmadd231pd 120(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm20\n\t"
                       "vfmadd231pd 120(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm21\n\t"
                       "vfmadd231pd 120(%%r10,%%r11,1)%{1to8%}, %%zmm1, %%zmm22\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,8)%{1to8%}, %%zmm1, %%zmm23\n\t"
                       "vfmadd231pd 120(%%rdx)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 120(%%rdx,%%r15,1)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 120(%%rdx,%%r15,2)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 120(%%rdx,%%rax,1)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 120(%%rdx,%%r15,4)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 120(%%rdx,%%rbx,1)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 120(%%rdx,%%rax,2)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 120(%%rdx,%%r11,1)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "popq %%rdx\n\t"
                       "vmovapd %%zmm6, 0(%%rdx)\n\t"
                       "vmovapd %%zmm7, 1024(%%rdx)\n\t"
                       "vmovapd %%zmm8, 2048(%%rdx)\n\t"
                       "vmovapd %%zmm9, 3072(%%rdx)\n\t"
                       "vmovapd %%zmm10, 4096(%%rdx)\n\t"
                       "vmovapd %%zmm11, 5120(%%rdx)\n\t"
                       "vmovapd %%zmm12, 6144(%%rdx)\n\t"
                       "vmovapd %%zmm13, 7168(%%rdx)\n\t"
                       "vmovapd %%zmm14, 8192(%%rdx)\n\t"
                       "vmovapd %%zmm15, 9216(%%rdx)\n\t"
                       "vmovapd %%zmm16, 10240(%%rdx)\n\t"
                       "vmovapd %%zmm17, 11264(%%rdx)\n\t"
                       "vmovapd %%zmm18, 12288(%%rdx)\n\t"
                       "vmovapd %%zmm19, 13312(%%rdx)\n\t"
                       "vmovapd %%zmm20, 14336(%%rdx)\n\t"
                       "vmovapd %%zmm21, 15360(%%rdx)\n\t"
                       "vmovapd %%zmm22, 16384(%%rdx)\n\t"
                       "vmovapd %%zmm23, 17408(%%rdx)\n\t"
                       "vmovapd %%zmm24, 18432(%%rdx)\n\t"
                       "vmovapd %%zmm25, 19456(%%rdx)\n\t"
                       "vmovapd %%zmm26, 20480(%%rdx)\n\t"
                       "vmovapd %%zmm27, 21504(%%rdx)\n\t"
                       "vmovapd %%zmm28, 22528(%%rdx)\n\t"
                       "vmovapd %%zmm29, 23552(%%rdx)\n\t"
                       "vmovapd %%zmm30, 24576(%%rdx)\n\t"
                       "vmovapd %%zmm31, 25600(%%rdx)\n\t"
                       "addq $64, %%rdx\n\t"
                       "addq $64, %%rdi\n\t"
                       "cmpq $16, %%r12\n\t"
                       "jl 34b\n\t"
                       ...
                       "addq $8, %%r12\n\t"
                       "vmovapd 0(%%rdx), %%zmm7\n\t"
                       "vmovapd 1024(%%rdx), %%zmm8\n\t"
                       "vmovapd 2048(%%rdx), %%zmm9\n\t"
                       "vmovapd 3072(%%rdx), %%zmm10\n\t"
                       "vmovapd 4096(%%rdx), %%zmm11\n\t"
                       "vmovapd 5120(%%rdx), %%zmm12\n\t"
                       "vmovapd 6144(%%rdx), %%zmm13\n\t"
                       "vmovapd 7168(%%rdx), %%zmm14\n\t"
                       "vmovapd 8192(%%rdx), %%zmm15\n\t"
                       "vmovapd 9216(%%rdx), %%zmm16\n\t"
                       "vmovapd 10240(%%rdx), %%zmm17\n\t"
                       "vmovapd 11264(%%rdx), %%zmm18\n\t"
                       "vmovapd 12288(%%rdx), %%zmm19\n\t"
                       "vmovapd 13312(%%rdx), %%zmm20\n\t"
                       "vmovapd 14336(%%rdx), %%zmm21\n\t"
                       "vmovapd 15360(%%rdx), %%zmm22\n\t"
                       "vmovapd 16384(%%rdx), %%zmm23\n\t"
                       "vmovapd 17408(%%rdx), %%zmm24\n\t"
                       "vmovapd 18432(%%rdx), %%zmm25\n\t"
                       "vmovapd 19456(%%rdx), %%zmm26\n\t"
                       "vmovapd 20480(%%rdx), %%zmm27\n\t"
                       "vmovapd 21504(%%rdx), %%zmm28\n\t"
                       "vmovapd 22528(%%rdx), %%zmm29\n\t"
                       "vmovapd 23552(%%rdx), %%zmm30\n\t"
                       "vmovapd 24576(%%rdx), %%zmm31\n\t"
                       "pushq %%rdx\n\t"
                       "movq $128, %%r15\n\t"
                       "movq $384, %%rax\n\t"
                       "movq $640, %%rbx\n\t"
                       ...
                       "vmovapd 1152(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 64(%%rsi)%{1to8%}, %%zmm0, %%zmm7\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm8\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm9\n\t"
                       "vfmadd231pd 64(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm10\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm11\n\t"
                       "vfmadd231pd 64(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm12\n\t"
                       "vfmadd231pd 64(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm13\n\t"
                       "vfmadd231pd 64(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm14\n\t"
                       "vfmadd231pd 64(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm15\n\t"
                       "vfmadd231pd 64(%%r10)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 64(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 64(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 64(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 64(%%r10,%%r11,1)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 64(%%r10,%%r15,8)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 64(%%rdx)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 64(%%rdx,%%r15,1)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 64(%%rdx,%%r15,2)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 64(%%rdx,%%rax,1)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 64(%%rdx,%%r15,4)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 64(%%rdx,%%rbx,1)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 64(%%rdx,%%rax,2)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       "vmovapd 1280(%%rdi), %%zmm0\n\t"
                       "vfmadd231pd 72(%%rsi)%{1to8%}, %%zmm1, %%zmm7\n\t"
                       "vfmadd231pd 72(%%rsi,%%r15,1)%{1to8%}, %%zmm1, %%zmm8\n\t"
                       "vfmadd231pd 72(%%rsi,%%r15,2)%{1to8%}, %%zmm1, %%zmm9\n\t"
                       "vfmadd231pd 72(%%rsi,%%rax,1)%{1to8%}, %%zmm1, %%zmm10\n\t"
                       "vfmadd231pd 72(%%rsi,%%r15,4)%{1to8%}, %%zmm1, %%zmm11\n\t"
                       "vfmadd231pd 72(%%rsi,%%rbx,1)%{1to8%}, %%zmm1, %%zmm12\n\t"
                       "vfmadd231pd 72(%%rsi,%%rax,2)%{1to8%}, %%zmm1, %%zmm13\n\t"
                       "vfmadd231pd 72(%%rsi,%%r11,1)%{1to8%}, %%zmm1, %%zmm14\n\t"
                       "vfmadd231pd 72(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm15\n\t"
                       "vfmadd231pd 72(%%r10)%{1to8%}, %%zmm1, %%zmm16\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm17\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm18\n\t"
                       "vfmadd231pd 72(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm19\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm20\n\t"
                       "vfmadd231pd 72(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm21\n\t"
                       "vfmadd231pd 72(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm22\n\t"
                       "vfmadd231pd 72(%%r10,%%r11,1)%{1to8%}, %%zmm1, %%zmm23\n\t"
                       "vfmadd231pd 72(%%r10,%%r15,8)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 72(%%rdx)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 72(%%rdx,%%r15,1)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 72(%%rdx,%%r15,2)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 72(%%rdx,%%rax,1)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 72(%%rdx,%%r15,4)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 72(%%rdx,%%rbx,1)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 72(%%rdx,%%rax,2)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "vmovapd 1408(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 80(%%rsi)%{1to8%}, %%zmm0, %%zmm7\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm8\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm9\n\t"
                       "vfmadd231pd 80(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm10\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm11\n\t"
                       "vfmadd231pd 80(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm12\n\t"
                       "vfmadd231pd 80(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm13\n\t"
                       "vfmadd231pd 80(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm14\n\t"
                       "vfmadd231pd 80(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm15\n\t"
                       "vfmadd231pd 80(%%r10)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 80(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 80(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 80(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 80(%%r10,%%r11,1)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 80(%%r10,%%r15,8)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 80(%%rdx)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 80(%%rdx,%%r15,1)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 80(%%rdx,%%r15,2)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 80(%%rdx,%%rax,1)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 80(%%rdx,%%r15,4)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 80(%%rdx,%%rbx,1)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 80(%%rdx,%%rax,2)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       "vmovapd 1536(%%rdi), %%zmm0\n\t"
                       "vfmadd231pd 88(%%rsi)%{1to8%}, %%zmm1, %%zmm7\n\t"
                       "vfmadd231pd 88(%%rsi,%%r15,1)%{1to8%}, %%zmm1, %%zmm8\n\t"
                       "vfmadd231pd 88(%%rsi,%%r15,2)%{1to8%}, %%zmm1, %%zmm9\n\t"
                       "vfmadd231pd 88(%%rsi,%%rax,1)%{1to8%}, %%zmm1, %%zmm10\n\t"
                       "vfmadd231pd 88(%%rsi,%%r15,4)%{1to8%}, %%zmm1, %%zmm11\n\t"
                       "vfmadd231pd 88(%%rsi,%%rbx,1)%{1to8%}, %%zmm1, %%zmm12\n\t"
                       "vfmadd231pd 88(%%rsi,%%rax,2)%{1to8%}, %%zmm1, %%zmm13\n\t"
                       "vfmadd231pd 88(%%rsi,%%r11,1)%{1to8%}, %%zmm1, %%zmm14\n\t"
                       "vfmadd231pd 88(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm15\n\t"
                       "vfmadd231pd 88(%%r10)%{1to8%}, %%zmm1, %%zmm16\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm17\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm18\n\t"
                       "vfmadd231pd 88(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm19\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm20\n\t"
                       "vfmadd231pd 88(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm21\n\t"
                       "vfmadd231pd 88(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm22\n\t"
                       "vfmadd231pd 88(%%r10,%%r11,1)%{1to8%}, %%zmm1, %%zmm23\n\t"
                       "vfmadd231pd 88(%%r10,%%r15,8)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 88(%%rdx)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 88(%%rdx,%%r15,1)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 88(%%rdx,%%r15,2)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 88(%%rdx,%%rax,1)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 88(%%rdx,%%r15,4)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 88(%%rdx,%%rbx,1)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 88(%%rdx,%%rax,2)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "vmovapd 1664(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 96(%%rsi)%{1to8%}, %%zmm0, %%zmm7\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm8\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm9\n\t"
                       "vfmadd231pd 96(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm10\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm11\n\t"
                       "vfmadd231pd 96(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm12\n\t"
                       "vfmadd231pd 96(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm13\n\t"
                       "vfmadd231pd 96(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm14\n\t"
                       "vfmadd231pd 96(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm15\n\t"
                       "vfmadd231pd 96(%%r10)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 96(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 96(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 96(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 96(%%r10,%%r11,1)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 96(%%r10,%%r15,8)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 96(%%rdx)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 96(%%rdx,%%r15,1)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 96(%%rdx,%%r15,2)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 96(%%rdx,%%rax,1)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 96(%%rdx,%%r15,4)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 96(%%rdx,%%rbx,1)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 96(%%rdx,%%rax,2)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       "vmovapd 1792(%%rdi), %%zmm0\n\t"
                       "vfmadd231pd 104(%%rsi)%{1to8%}, %%zmm1, %%zmm7\n\t"
                       "vfmadd231pd 104(%%rsi,%%r15,1)%{1to8%}, %%zmm1, %%zmm8\n\t"
                       "vfmadd231pd 104(%%rsi,%%r15,2)%{1to8%}, %%zmm1, %%zmm9\n\t"
                       "vfmadd231pd 104(%%rsi,%%rax,1)%{1to8%}, %%zmm1, %%zmm10\n\t"
                       "vfmadd231pd 104(%%rsi,%%r15,4)%{1to8%}, %%zmm1, %%zmm11\n\t"
                       "vfmadd231pd 104(%%rsi,%%rbx,1)%{1to8%}, %%zmm1, %%zmm12\n\t"
                       "vfmadd231pd 104(%%rsi,%%rax,2)%{1to8%}, %%zmm1, %%zmm13\n\t"
                       "vfmadd231pd 104(%%rsi,%%r11,1)%{1to8%}, %%zmm1, %%zmm14\n\t"
                       "vfmadd231pd 104(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm15\n\t"
                       "vfmadd231pd 104(%%r10)%{1to8%}, %%zmm1, %%zmm16\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm17\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm18\n\t"
                       "vfmadd231pd 104(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm19\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm20\n\t"
                       "vfmadd231pd 104(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm21\n\t"
                       "vfmadd231pd 104(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm22\n\t"
                       "vfmadd231pd 104(%%r10,%%r11,1)%{1to8%}, %%zmm1, %%zmm23\n\t"
                       "vfmadd231pd 104(%%r10,%%r15,8)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 104(%%rdx)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 104(%%rdx,%%r15,1)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 104(%%rdx,%%r15,2)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 104(%%rdx,%%rax,1)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 104(%%rdx,%%r15,4)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 104(%%rdx,%%rbx,1)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 104(%%rdx,%%rax,2)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "vmovapd 1920(%%rdi), %%zmm1\n\t"
                       "vfmadd231pd 112(%%rsi)%{1to8%}, %%zmm0, %%zmm7\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,1)%{1to8%}, %%zmm0, %%zmm8\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,2)%{1to8%}, %%zmm0, %%zmm9\n\t"
                       "vfmadd231pd 112(%%rsi,%%rax,1)%{1to8%}, %%zmm0, %%zmm10\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,4)%{1to8%}, %%zmm0, %%zmm11\n\t"
                       "vfmadd231pd 112(%%rsi,%%rbx,1)%{1to8%}, %%zmm0, %%zmm12\n\t"
                       "vfmadd231pd 112(%%rsi,%%rax,2)%{1to8%}, %%zmm0, %%zmm13\n\t"
                       "vfmadd231pd 112(%%rsi,%%r11,1)%{1to8%}, %%zmm0, %%zmm14\n\t"
                       "vfmadd231pd 112(%%rsi,%%r15,8)%{1to8%}, %%zmm0, %%zmm15\n\t"
                       "vfmadd231pd 112(%%r10)%{1to8%}, %%zmm0, %%zmm16\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,1)%{1to8%}, %%zmm0, %%zmm17\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,2)%{1to8%}, %%zmm0, %%zmm18\n\t"
                       "vfmadd231pd 112(%%r10,%%rax,1)%{1to8%}, %%zmm0, %%zmm19\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,4)%{1to8%}, %%zmm0, %%zmm20\n\t"
                       "vfmadd231pd 112(%%r10,%%rbx,1)%{1to8%}, %%zmm0, %%zmm21\n\t"
                       "vfmadd231pd 112(%%r10,%%rax,2)%{1to8%}, %%zmm0, %%zmm22\n\t"
                       "vfmadd231pd 112(%%r10,%%r11,1)%{1to8%}, %%zmm0, %%zmm23\n\t"
                       "vfmadd231pd 112(%%r10,%%r15,8)%{1to8%}, %%zmm0, %%zmm24\n\t"
                       "vfmadd231pd 112(%%rdx)%{1to8%}, %%zmm0, %%zmm25\n\t"
                       "vfmadd231pd 112(%%rdx,%%r15,1)%{1to8%}, %%zmm0, %%zmm26\n\t"
                       "vfmadd231pd 112(%%rdx,%%r15,2)%{1to8%}, %%zmm0, %%zmm27\n\t"
                       "vfmadd231pd 112(%%rdx,%%rax,1)%{1to8%}, %%zmm0, %%zmm28\n\t"
                       "vfmadd231pd 112(%%rdx,%%r15,4)%{1to8%}, %%zmm0, %%zmm29\n\t"
                       "vfmadd231pd 112(%%rdx,%%rbx,1)%{1to8%}, %%zmm0, %%zmm30\n\t"
                       "vfmadd231pd 112(%%rdx,%%rax,2)%{1to8%}, %%zmm0, %%zmm31\n\t"
                       "vfmadd231pd 120(%%rsi)%{1to8%}, %%zmm1, %%zmm7\n\t"
                       "vfmadd231pd 120(%%rsi,%%r15,1)%{1to8%}, %%zmm1, %%zmm8\n\t"
                       "vfmadd231pd 120(%%rsi,%%r15,2)%{1to8%}, %%zmm1, %%zmm9\n\t"
                       "vfmadd231pd 120(%%rsi,%%rax,1)%{1to8%}, %%zmm1, %%zmm10\n\t"
                       "vfmadd231pd 120(%%rsi,%%r15,4)%{1to8%}, %%zmm1, %%zmm11\n\t"
                       "vfmadd231pd 120(%%rsi,%%rbx,1)%{1to8%}, %%zmm1, %%zmm12\n\t"
                       "vfmadd231pd 120(%%rsi,%%rax,2)%{1to8%}, %%zmm1, %%zmm13\n\t"
                       "vfmadd231pd 120(%%rsi,%%r11,1)%{1to8%}, %%zmm1, %%zmm14\n\t"
                       "vfmadd231pd 120(%%rsi,%%r15,8)%{1to8%}, %%zmm1, %%zmm15\n\t"
                       "vfmadd231pd 120(%%r10)%{1to8%}, %%zmm1, %%zmm16\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,1)%{1to8%}, %%zmm1, %%zmm17\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,2)%{1to8%}, %%zmm1, %%zmm18\n\t"
                       "vfmadd231pd 120(%%r10,%%rax,1)%{1to8%}, %%zmm1, %%zmm19\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,4)%{1to8%}, %%zmm1, %%zmm20\n\t"
                       "vfmadd231pd 120(%%r10,%%rbx,1)%{1to8%}, %%zmm1, %%zmm21\n\t"
                       "vfmadd231pd 120(%%r10,%%rax,2)%{1to8%}, %%zmm1, %%zmm22\n\t"
                       "vfmadd231pd 120(%%r10,%%r11,1)%{1to8%}, %%zmm1, %%zmm23\n\t"
                       "vfmadd231pd 120(%%r10,%%r15,8)%{1to8%}, %%zmm1, %%zmm24\n\t"
                       "vfmadd231pd 120(%%rdx)%{1to8%}, %%zmm1, %%zmm25\n\t"
                       "vfmadd231pd 120(%%rdx,%%r15,1)%{1to8%}, %%zmm1, %%zmm26\n\t"
                       "vfmadd231pd 120(%%rdx,%%r15,2)%{1to8%}, %%zmm1, %%zmm27\n\t"
                       "vfmadd231pd 120(%%rdx,%%rax,1)%{1to8%}, %%zmm1, %%zmm28\n\t"
                       "vfmadd231pd 120(%%rdx,%%r15,4)%{1to8%}, %%zmm1, %%zmm29\n\t"
                       "vfmadd231pd 120(%%rdx,%%rbx,1)%{1to8%}, %%zmm1, %%zmm30\n\t"
                       "vfmadd231pd 120(%%rdx,%%rax,2)%{1to8%}, %%zmm1, %%zmm31\n\t"
                       "popq %%rdx\n\t"
                       "vmovapd %%zmm7, 0(%%rdx)\n\t"
                       "vmovapd %%zmm8, 1024(%%rdx)\n\t"
                       "vmovapd %%zmm9, 2048(%%rdx)\n\t"
                       "vmovapd %%zmm10, 3072(%%rdx)\n\t"
                       "vmovapd %%zmm11, 4096(%%rdx)\n\t"
                       "vmovapd %%zmm12, 5120(%%rdx)\n\t"
                       "vmovapd %%zmm13, 6144(%%rdx)\n\t"
                       "vmovapd %%zmm14, 7168(%%rdx)\n\t"
                       "vmovapd %%zmm15, 8192(%%rdx)\n\t"
                       "vmovapd %%zmm16, 9216(%%rdx)\n\t"
                       "vmovapd %%zmm17, 10240(%%rdx)\n\t"
                       "vmovapd %%zmm18, 11264(%%rdx)\n\t"
                       "vmovapd %%zmm19, 12288(%%rdx)\n\t"
                       "vmovapd %%zmm20, 13312(%%rdx)\n\t"
                       "vmovapd %%zmm21, 14336(%%rdx)\n\t"
                       "vmovapd %%zmm22, 15360(%%rdx)\n\t"
                       "vmovapd %%zmm23, 16384(%%rdx)\n\t"
                       "vmovapd %%zmm24, 17408(%%rdx)\n\t"
                       "vmovapd %%zmm25, 18432(%%rdx)\n\t"
                       "vmovapd %%zmm26, 19456(%%rdx)\n\t"
                       "vmovapd %%zmm27, 20480(%%rdx)\n\t"
                       "vmovapd %%zmm28, 21504(%%rdx)\n\t"
                       "vmovapd %%zmm29, 22528(%%rdx)\n\t"
                       "vmovapd %%zmm30, 23552(%%rdx)\n\t"
                       "vmovapd %%zmm31, 24576(%%rdx)\n\t"
                       "addq $64, %%rdx\n\t"
                       "addq $64, %%rdi\n\t"
                       "cmpq $16, %%r12\n\t"
                       "jl 34b\n\t"
